...
=======================================================
Файл: /engine/modules/stream-info-main.php
-------------------------------------------------------
Назначение: Вывод online трансляций на главную страницу
======================================================*/
...
if ($stream_config['allow_stream'] == '1') {
    ...
    $stream_list  = $db->super_query("SELECT id, title, login, service, description, pic, date FROM " . PREFIX . "_streams ORDER BY id", true);
